...
const (
	// LDefault is the default log flag of builder. It means no logging at all.
	LDefault = iota

	// LQuery logs only the queries generated by the builder.
	LQuery

	// LBindings logs only the bindings generated by the builder.
	LBindings
)
